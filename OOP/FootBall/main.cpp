...
int main(int argc, const char * argv[]) {
    ...
    Team team1("Team1", "Address1", "City1", "Coach1", {"Player1", "Player2"}, 10, 5, 3, 2, 17, 1, "team1.jpg");
    Team team2("Team2", "Address2", "City2", "Coach2", {"Player3", "Player4"}, 9, 4, 2, 3, 14, 2, "team2.jpg");
    
    Refferee referee("Referee1", "RefereePass");
    
    vector<Match> matches;
    matches.push_back(Match(1, "2024-01-25", "18:00", "Stadium1", "City1", team1, team2, referee, 15));
